...
{
    public abstract class GenericRepo<TEntity>where TEntity : class
    {
        protected readonly FUFlowerBouquetManagementV4Context Context;

        public GenericRepo(FUFlowerBouquetManagementV4Context context)
        {
            Context = context;
        }
